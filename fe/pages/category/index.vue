      ...
      <v-card class="my-3">
        ...
        <v-card-text>
          ...
          <div class="d-flex mb-4">
            ...
            <v-spacer></v-spacer>
            <v-btn dark :color="$vuetify.theme.themes.dark.secondary" to="/category/add" elevation="3" small
          ...
          >
            ...
            <template v-slot:item.actions="{ item }">
              <v-btn dark :color="$vuetify.theme.themes.dark.info" :to="`/category/edit/${item.uuid}`" icon
